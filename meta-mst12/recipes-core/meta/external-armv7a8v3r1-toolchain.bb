...
SUMMARY = "External VDLinux-arm-v7a8v3r1 toolchain"
LICENSE = "MIT"
...
SRC_URI = "http://download.samygo.tv/Toolchains/VDLinux-arm-v7a8v3r1.tar.xz   \
file://SUPPORTED"

SRC_URI[md5sum] = "075f46df99da41ce8a1dbd0f300f56b1"
SRC_URI[sha256sum] = "6429a5a8d39d4db938c9a417c9f3b0b622b1dcf5739f7a66f53ed321968f2929"

CSL_RELOCATE = "/VDLinux-arm-v7a8v3r1"
...
do_install() {
	...
	install -d ${EXTERNAL_CROSS_DIR}/arm-v7a8v3r1
	cp -a ${WORKDIR}/${CSL_RELOCATE}/* ${EXTERNAL_CROSS_DIR}/arm-v7a8v3r1
