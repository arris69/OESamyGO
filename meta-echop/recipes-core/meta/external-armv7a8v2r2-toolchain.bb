...
SRC_URI = "http://download.samygo.tv/Toolchains/VDLinux-ARMv7-4.4-202-toolchain-v2r2-20110630.tar.xz  \
file://SUPPORTED"

SRC_URI[md5sum] = "7fd5ba9b6e7a4258483e5f5a77f1e19a"
SRC_URI[sha256sum] = "118b54de52ad41213b838504525edc22af27abeea87fc290d04b90875ad2908f"



CSL_RELOCATE = "/VDLinux-ARMv7-4.4-202-toolchain-v2r2-20110630"
...
do_install() {
	...
	install -d ${EXTERNAL_CROSS_DIR}/arm-v7a8v2r2
	cp -a ${WORKDIR}/${CSL_RELOCATE}/* ${EXTERNAL_CROSS_DIR}/arm-v7a8v2r2
