...
SUMMARY = "External arm-v7a15v3r1 toolchain"
LICENSE = "MIT"
...
#	glibc-pcprofile 
#	glibc-doc 
#	glibc-staticdev libc-staticdev 
#	glibc-pic 
#	glibc-dbg 
#	glibc-extra-nss 
#	glibc-dev libc6-dev virtual-libc-dev libc-dev 
#	glibc-thread-db 
#	glibc rtld(GNU_HASH) 
#	glibc-utils 
...
SRC_URI[md5sum] = "6dd7af0bfd9b2b440967c04703442b18"
SRC_URI[sha256sum] = "fb82c82524b993005ff61e23f6c8861dc43e7505f06e731219de4db685002c4d"
CSL_RELOCATE = "/VDLinux-arm-v7a15v3r1"
...
do_install() {
	...
	install -d ${EXTERNAL_CROSS_DIR}/arm-v7a15v3r1
	cp -a ${WORKDIR}/${CSL_RELOCATE}/* ${EXTERNAL_CROSS_DIR}/arm-v7a15v3r1
