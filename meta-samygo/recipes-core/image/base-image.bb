...
DEPENDS += "samygoso apache2 dropbear mc patch usbutils strace setserial diffutils gawk grep groff gzip curl wget samba ser2net lua hexedit vim xclock oscam qemu v4l-utils yavta"
